...
//  jaem
//
//  Created by limtaegeun on 2016. 5. 1..
...
public class JaemIconStyleKit : NSObject {
    ...
    public class func drawHome() {
        ...
        //// Group 5
        //// Fill-183 Drawing
        let fill183Path = UIBezierPath()
        fill183Path.moveToPoint(CGPoint(x: 18.06, y: 10.56))
        fill183Path.addCurveToPoint(CGPoint(x: 17.7, y: 10.91), controlPoint1: CGPoint(x: 17.86, y: 10.56), controlPoint2: CGPoint(x: 17.7, y: 10.72))
        fill183Path.addLineToPoint(CGPoint(x: 17.7, y: 18.73))
        fill183Path.addCurveToPoint(CGPoint(x: 16.14, y: 20.29), controlPoint1: CGPoint(x: 17.7, y: 19.59), controlPoint2: CGPoint(x: 17, y: 20.29))
        fill183Path.addLineToPoint(CGPoint(x: 13.39, y: 20.29))
        fill183Path.addLineToPoint(CGPoint(x: 13.39, y: 14.86))
        fill183Path.addCurveToPoint(CGPoint(x: 13.03, y: 14.51), controlPoint1: CGPoint(x: 13.39, y: 14.67), controlPoint2: CGPoint(x: 13.23, y: 14.51))
        fill183Path.addLineToPoint(CGPoint(x: 9.16, y: 14.51))
        fill183Path.addCurveToPoint(CGPoint(x: 8.81, y: 14.86), controlPoint1: CGPoint(x: 8.97, y: 14.51), controlPoint2: CGPoint(x: 8.81, y: 14.67))
        fill183Path.addLineToPoint(CGPoint(x: 8.81, y: 20.29))
        fill183Path.addLineToPoint(CGPoint(x: 6.06, y: 20.29))
        fill183Path.addCurveToPoint(CGPoint(x: 4.5, y: 18.73), controlPoint1: CGPoint(x: 5.2, y: 20.29), controlPoint2: CGPoint(x: 4.5, y: 19.59))
        fill183Path.addLineToPoint(CGPoint(x: 4.5, y: 10.91))
        fill183Path.addCurveToPoint(CGPoint(x: 4.14, y: 10.56), controlPoint1: CGPoint(x: 4.5, y: 10.72), controlPoint2: CGPoint(x: 4.34, y: 10.56))
        fill183Path.addCurveToPoint(CGPoint(x: 3.79, y: 10.91), controlPoint1: CGPoint(x: 3.95, y: 10.56), controlPoint2: CGPoint(x: 3.79, y: 10.72))
        fill183Path.addLineToPoint(CGPoint(x: 3.79, y: 18.73))
        fill183Path.addCurveToPoint(CGPoint(x: 6.06, y: 21), controlPoint1: CGPoint(x: 3.79, y: 19.98), controlPoint2: CGPoint(x: 4.81, y: 21))
        fill183Path.addLineToPoint(CGPoint(x: 16.14, y: 21))
        fill183Path.addCurveToPoint(CGPoint(x: 18.41, y: 18.73), controlPoint1: CGPoint(x: 17.39, y: 21), controlPoint2: CGPoint(x: 18.41, y: 19.98))
        fill183Path.addLineToPoint(CGPoint(x: 18.41, y: 10.91))
        fill183Path.addCurveToPoint(CGPoint(x: 18.06, y: 10.56), controlPoint1: CGPoint(x: 18.41, y: 10.72), controlPoint2: CGPoint(x: 18.25, y: 10.56))
        fill183Path.addLineToPoint(CGPoint(x: 18.06, y: 10.56))
        fill183Path.closePath()
        fill183Path.moveToPoint(CGPoint(x: 9.52, y: 15.22))
        fill183Path.addLineToPoint(CGPoint(x: 12.68, y: 15.22))
        fill183Path.addLineToPoint(CGPoint(x: 12.68, y: 20.29))
        fill183Path.addLineToPoint(CGPoint(x: 9.52, y: 20.29))
        fill183Path.addLineToPoint(CGPoint(x: 9.52, y: 15.22))
        fill183Path.closePath()
        fill183Path.moveToPoint(CGPoint(x: 21.56, y: 7.94))
        fill183Path.addLineToPoint(CGPoint(x: 19, y: 6.09))
        fill183Path.addCurveToPoint(CGPoint(x: 18.37, y: 4.86), controlPoint1: CGPoint(x: 18.66, y: 5.85), controlPoint2: CGPoint(x: 18.37, y: 5.27))
        fill183Path.addLineToPoint(CGPoint(x: 18.37, y: 1.82))
        fill183Path.addCurveToPoint(CGPoint(x: 17.06, y: 0.51), controlPoint1: CGPoint(x: 18.37, y: 1.1), controlPoint2: CGPoint(x: 17.78, y: 0.51))
        fill183Path.addLineToPoint(CGPoint(x: 16.16, y: 0.51))
        fill183Path.addCurveToPoint(CGPoint(x: 14.85, y: 1.82), controlPoint1: CGPoint(x: 15.44, y: 0.51), controlPoint2: CGPoint(x: 14.85, y: 1.1))
        fill183Path.addLineToPoint(CGPoint(x: 14.85, y: 2.83))
        fill183Path.addCurveToPoint(CGPoint(x: 14.82, y: 3.03), controlPoint1: CGPoint(x: 14.85, y: 2.96), controlPoint2: CGPoint(x: 14.82, y: 3.02))
        fill183Path.addCurveToPoint(CGPoint(x: 14.63, y: 2.94), controlPoint1: CGPoint(x: 14.8, y: 3.03), controlPoint2: CGPoint(x: 14.74, y: 3.02))
        fill183Path.addLineToPoint(CGPoint(x: 11.99, y: 1.03))
        fill183Path.addCurveToPoint(CGPoint(x: 11.35, y: 0.57), controlPoint1: CGPoint(x: 11.66, y: 0.8), controlPoint2: CGPoint(x: 11.4, y: 0.61))
        fill183Path.addCurveToPoint(CGPoint(x: 11.1, y: 0.47), controlPoint1: CGPoint(x: 11.28, y: 0.51), controlPoint2: CGPoint(x: 11.19, y: 0.47))
        fill183Path.addCurveToPoint(CGPoint(x: 10.85, y: 0.57), controlPoint1: CGPoint(x: 11.02, y: 0.47), controlPoint2: CGPoint(x: 10.92, y: 0.51))
        fill183Path.addCurveToPoint(CGPoint(x: 10.09, y: 1.12), controlPoint1: CGPoint(x: 10.79, y: 0.61), controlPoint2: CGPoint(x: 10.47, y: 0.85))
        fill183Path.addLineToPoint(CGPoint(x: 0.64, y: 7.94))
        fill183Path.addCurveToPoint(CGPoint(x: 0.12, y: 8.79), controlPoint1: CGPoint(x: 0.36, y: 8.14), controlPoint2: CGPoint(x: 0.17, y: 8.44))
        fill183Path.addCurveToPoint(CGPoint(x: 0.35, y: 9.76), controlPoint1: CGPoint(x: 0.06, y: 9.14), controlPoint2: CGPoint(x: 0.14, y: 9.48))
        fill183Path.addLineToPoint(CGPoint(x: 0.71, y: 10.26))
        fill183Path.addCurveToPoint(CGPoint(x: 1.77, y: 10.79), controlPoint1: CGPoint(x: 0.95, y: 10.6), controlPoint2: CGPoint(x: 1.33, y: 10.79))
        fill183Path.addLineToPoint(CGPoint(x: 1.77, y: 10.79))
        fill183Path.addCurveToPoint(CGPoint(x: 1.9, y: 10.79), controlPoint1: CGPoint(x: 1.81, y: 10.79), controlPoint2: CGPoint(x: 1.86, y: 10.79))
        fill183Path.addCurveToPoint(CGPoint(x: 2.08, y: 10.72), controlPoint1: CGPoint(x: 1.97, y: 10.78), controlPoint2: CGPoint(x: 2.02, y: 10.76))
        fill183Path.addLineToPoint(CGPoint(x: 11.1, y: 4.21))
        fill183Path.addLineToPoint(CGPoint(x: 20.12, y: 10.72))
        fill183Path.addCurveToPoint(CGPoint(x: 20.3, y: 10.79), controlPoint1: CGPoint(x: 20.18, y: 10.76), controlPoint2: CGPoint(x: 20.24, y: 10.78))
        fill183Path.addCurveToPoint(CGPoint(x: 20.44, y: 10.79), controlPoint1: CGPoint(x: 20.34, y: 10.79), controlPoint2: CGPoint(x: 20.39, y: 10.79))
        fill183Path.addCurveToPoint(CGPoint(x: 21.49, y: 10.26), controlPoint1: CGPoint(x: 20.87, y: 10.79), controlPoint2: CGPoint(x: 21.25, y: 10.6))
        fill183Path.addLineToPoint(CGPoint(x: 21.85, y: 9.76))
        fill183Path.addCurveToPoint(CGPoint(x: 21.56, y: 7.94), controlPoint1: CGPoint(x: 22.28, y: 9.18), controlPoint2: CGPoint(x: 22.14, y: 8.36))
        fill183Path.addLineToPoint(CGPoint(x: 21.56, y: 7.94))
        fill183Path.closePath()
        fill183Path.moveToPoint(CGPoint(x: 21.28, y: 9.35))
        fill183Path.addLineToPoint(CGPoint(x: 20.92, y: 9.85))
        fill183Path.addCurveToPoint(CGPoint(x: 20.45, y: 10.08), controlPoint1: CGPoint(x: 20.81, y: 10), controlPoint2: CGPoint(x: 20.65, y: 10.08))
        fill183Path.addLineToPoint(CGPoint(x: 11.31, y: 3.49))
        fill183Path.addLineToPoint(CGPoint(x: 11.31, y: 3.49))
        fill183Path.addCurveToPoint(CGPoint(x: 10.88, y: 3.49), controlPoint1: CGPoint(x: 11.19, y: 3.4), controlPoint2: CGPoint(x: 11.01, y: 3.4))
        fill183Path.addLineToPoint(CGPoint(x: 1.75, y: 10.08))
        fill183Path.addCurveToPoint(CGPoint(x: 1.28, y: 9.85), controlPoint1: CGPoint(x: 1.55, y: 10.08), controlPoint2: CGPoint(x: 1.39, y: 10))
        fill183Path.addLineToPoint(CGPoint(x: 0.92, y: 9.35))
        fill183Path.addCurveToPoint(CGPoint(x: 0.82, y: 8.9), controlPoint1: CGPoint(x: 0.83, y: 9.22), controlPoint2: CGPoint(x: 0.79, y: 9.06))
        fill183Path.addCurveToPoint(CGPoint(x: 1.06, y: 8.51), controlPoint1: CGPoint(x: 0.84, y: 8.74), controlPoint2: CGPoint(x: 0.93, y: 8.6))
        fill183Path.addLineToPoint(CGPoint(x: 10.51, y: 1.69))
        fill183Path.addCurveToPoint(CGPoint(x: 11.1, y: 1.26), controlPoint1: CGPoint(x: 10.79, y: 1.49), controlPoint2: CGPoint(x: 10.97, y: 1.36))
        fill183Path.addCurveToPoint(CGPoint(x: 11.57, y: 1.6), controlPoint1: CGPoint(x: 11.21, y: 1.34), controlPoint2: CGPoint(x: 11.36, y: 1.45))
        fill183Path.addLineToPoint(CGPoint(x: 14.22, y: 3.52))
        fill183Path.addCurveToPoint(CGPoint(x: 14.82, y: 3.73), controlPoint1: CGPoint(x: 14.42, y: 3.66), controlPoint2: CGPoint(x: 14.62, y: 3.73))
        fill183Path.addCurveToPoint(CGPoint(x: 15.56, y: 2.83), controlPoint1: CGPoint(x: 15.19, y: 3.73), controlPoint2: CGPoint(x: 15.56, y: 3.46))
        fill183Path.addLineToPoint(CGPoint(x: 15.56, y: 1.82))
        fill183Path.addCurveToPoint(CGPoint(x: 16.16, y: 1.22), controlPoint1: CGPoint(x: 15.56, y: 1.49), controlPoint2: CGPoint(x: 15.83, y: 1.22))
        fill183Path.addLineToPoint(CGPoint(x: 17.06, y: 1.22))
        fill183Path.addCurveToPoint(CGPoint(x: 17.66, y: 1.82), controlPoint1: CGPoint(x: 17.39, y: 1.22), controlPoint2: CGPoint(x: 17.66, y: 1.49))
        fill183Path.addLineToPoint(CGPoint(x: 17.66, y: 4.86))
        fill183Path.addCurveToPoint(CGPoint(x: 18.58, y: 6.66), controlPoint1: CGPoint(x: 17.66, y: 5.5), controlPoint2: CGPoint(x: 18.06, y: 6.29))
        fill183Path.addLineToPoint(CGPoint(x: 21.14, y: 8.51))
        fill183Path.addCurveToPoint(CGPoint(x: 21.28, y: 9.35), controlPoint1: CGPoint(x: 21.41, y: 8.7), controlPoint2: CGPoint(x: 21.47, y: 9.08))
        fill183Path.addLineToPoint(CGPoint(x: 21.28, y: 9.35))
        fill183Path.closePath()
        fill183Path.miterLimit = 4;

        fill183Path.usesEvenOddFillRule = true;
    ...
    @IBOutlet var homeTargets: [AnyObject]! {
        get { return Cache.homeTargets }
        set {
            Cache.homeTargets = newValue
            for target: AnyObject in newValue {
                target.performSelector(NSSelectorFromString("setImage:"), withObject: JaemIconStyleKit.imageOfHome)
            }
        }
    }
